...
module.exports = function (app, tfa, passport, login) {
  ...
  app.get('/lostpassword', login.ensureNotLoggedIn('/account'), require('../../routes/lostpassword').index);
  app.get('/newpassword/:token', login.ensureNotLoggedIn('/account'), require('../../routes/newpassword').index);
  app.post('/newpassword/:token', login.ensureNotLoggedIn('/account'), require('../../routes/newpassword').index);
  ...
  app.post('/lostpassword', require('../../routes/lostpassword').request);
  ...
  app.get('/notification', login.ensureLoggedIn('/login'), require('../../routes/notification').index);
  app.get('/mobile-login', login.ensureLoggedIn('/login'), tfa.ensure, require('../../routes/mobilelogin').get);
};
